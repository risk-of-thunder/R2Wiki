...
2. Launch [two instances](#create-an-executable-shortcut-for-modded-profiles) of the game. Ensure crossplay is disabled.
3. Host a private lobby and enter character select with one instance
