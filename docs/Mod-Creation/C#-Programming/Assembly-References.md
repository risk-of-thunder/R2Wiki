...
-   In your .csproj (Visual Studio C# Project) file, [have these lines](https://github.com/risk-of-thunder/ExamplePlugin/blob/master/ExamplePlugin/ExamplePlugin.csproj#L14-L29), and [these lines](https://github.com/risk-of-thunder/ExamplePlugin/blob/main/ExamplePlugin/ExamplePlugin.csproj#L8-L11)
